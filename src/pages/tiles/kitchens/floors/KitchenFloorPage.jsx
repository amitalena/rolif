...
import { kitchenFloorData } from './kitchenFloorData';

const KitchenFloorPage = () => {
    const theme = useTheme();
    const navigate = useNavigate();
    const handleClick = (id) => {
        const selectedFurniture = kitchenFloorData.find((item) => item.id === id);
...
export default KitchenFloorPage;
