...
import { bathroomWallData } from './bathroomWallData';

const BedroomWallPage = () => {
    const theme = useTheme();
    const navigate = useNavigate();
    const handleClick = (id) => {
        const selectedFurniture = bathroomWallData.find((item) => item.id === id);
