...
import { bathroomFloorData } from './floors/bathroomFloorData';
import { bathroomWallData } from './walls/bathroomWallData';
...
const allSlides = interleaveData(bathroomFloorData, bathroomWallData);
...
export default React.memo(BathroomPage);
