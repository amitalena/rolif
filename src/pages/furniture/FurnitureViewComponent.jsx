...
import S1 from "../../assets/images/interior/sofas/sofa0.jpg";
...
const FurnitureViewComponent = React.memo(({ view }) => {
    ...
    useEffect(() => {
        ...
        if (selectedFurniture && selectedFurniture.id === parseInt(id, 10)) {
            setSelectedImage(selectedFurniture.imagePath);
        }
    }, [id]);
...
export default FurnitureViewComponent;