...
const ProductPage = lazy(() => import("../pages/tiles/livingrooms/LivingPage"));
...
const LightInstallationPage = lazy(() => import("../pages/electric/lightInstallation/LightInstallationPage"));
...
const routes = [
    ...
    { path: "/category/:category/product/:id/:title", element: <ProductPage /> },
    ...
    { path: "/electrics/light_installation", element: <LightInstallationPage /> },
