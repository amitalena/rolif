                            ...
                            <Dropdown key={subIndex} onMouseEnter={() => setNestedIndex(subIndex)} onMouseLeave={() => setNestedIndex(null)}>
                                ...
                                <AnimatePresence>
                                    {nestedIndex === subIndex && subItem.subMenu && (
                                        <DropdownContent variants={nestedVariants} initial="hidden" animate="visible" exit="exit" transition={{ duration: 0.3 }} sx={{ left: "100%", top: 3 }}>
